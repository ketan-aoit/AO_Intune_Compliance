...
const mockComplianceRules = [
  { id: '1', name: 'Windows OS Version', description: 'Ensures Windows devices are running supported OS versions', ruleType: 'Operating System', isEnabled: true, severity: 'High', configuration: '{}', applicableOs: 'Windows', createdAt: '2025-01-01T00:00:00Z', updatedAt: null },
  { id: '2', name: 'macOS Version', description: 'Ensures macOS devices are running supported versions', ruleType: 'Operating System', isEnabled: true, severity: 'High', configuration: '{}', applicableOs: 'macOS', createdAt: '2025-01-01T00:00:00Z', updatedAt: null },
  { id: '3', name: 'Browser Version Check', description: 'Ensures browsers are up to date', ruleType: 'Browser', isEnabled: true, severity: 'Medium', configuration: '{}', applicableOs: null, createdAt: '2025-01-01T00:00:00Z', updatedAt: null },
  { id: '4', name: 'Disk Encryption', description: 'Ensures device storage is encrypted', ruleType: 'Security', isEnabled: true, severity: 'Critical', configuration: '{}', applicableOs: null, createdAt: '2025-01-01T00:00:00Z', updatedAt: null },
];
